...
```{r echo=FALSE,fig.align="c", fig.show='hold',fig.cap="Figure 51-60", out.width = '50%'}
knitr::include_graphics("gb_trending_lifecycle_bar_all.png")
knitr::include_graphics("us_trending_lifecycle_bar_all.png")
knitr::include_graphics("ca_trending_lifecycle_bar_all.png")
knitr::include_graphics("ind_trending_lifecycle_bar_all.png")
knitr::include_graphics("fr_trending_lifecycle_bar_all.png")
knitr::include_graphics("kr_trending_lifecycle_bar_all.png")
knitr::include_graphics("de_trending_lifecycle_bar_all.png")
knitr::include_graphics("mx_trending_lifecycle_bar_all.png")
knitr::include_graphics("ru_trending_lifecycle_bar_all.png")
knitr::include_graphics("jp_trending_lifecycle_bar_all.png")
...
kable(coef(model3)$country)

```

** Model checking ** 
<br>
As is shown in the residual plot, there is no clear pattern. 

```{r,fig.height=5,fig.width=5,fig.align="c"}
#model checking
plot(model3)
